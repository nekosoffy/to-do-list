...
;// CONCATENATED MODULE: ./src/project-display.js



// Helper functions
const project_display_select = (target) => document.querySelector(target);
...
const projectDisplay = () => {
    ...
    const projectForm = project_display_select(".project-form");
    const formInput = project_display_select(".project-form input");
    const label = project_display_select("[for=project-title]");
    const projectTitle = selectId("project-title");
    const cancelBtn = project_display_select(".project-form .cancel-btn");
    ...
    function updateProjects() {
        ...
        const firstProject = project_display_select('[data-index="0"]');
        const secondProject = project_display_select('[data-index="1"]');
        const deleteBtn = project_display_select(".delete-btn");

        if (projectsContainer.contains(secondProject) && 
        !firstProject.querySelector(".delete-btn")) { // Allows deleting default project after there is at least another one.
        const buttonWrapper = firstProject.querySelector(".button-wrapper");

            if (buttonWrapper) { // Ensure buttonWrapper exists before removing
                ...
                create("button", newButtonWrapper, "", "edit-btn", "Edit").classList.add("hidden");
                create("button", newButtonWrapper, "", "delete-btn", "Delete").classList.add("hidden");
    ...
    function showProjectTitle(index) {
        const h3 = project_display_select("h3");
...
;// CONCATENATED MODULE: ./src/task-display.js
...
const taskDisplay = () => {
    ...
    const cancelBtn = project_display_select("#task-form .cancel-btn");
    const checklistConfirmBtn = selectId("new-checklist-button");
    const fieldset = project_display_select("#task-form fieldset");
    const itemInput = project_display_select("#new-checklist-item");
    const ul = project_display_select(".checklist");
    const tasksContainer = project_display_select("#tasks-container");
    let currentIndex = null;
